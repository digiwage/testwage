...
This mechanism has been integrated into Bitcore-Node-TESTWAGE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TESTWAGE-Project/insight-api-testwage#web-socket-api](https://github.com/TESTWAGE-Project/insight-api-testwage#web-socket-api) 
* API: [https://github.com/TESTWAGE-Project/insight-api-testwage#swifttx-transactions](https://github.com/TESTWAGE-Project/insight-api-testwage#swifttx-transactions) 
...
By default, the TESTWAGE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TESTWAGE Core daemon:
