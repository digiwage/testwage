...
In order to support loading of multiple wallets in testwage-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is testwage.cpp.
...
Changes to testwage.cpp
----------------------
testwage.cpp is the entry point into testwage-qt, and as such, will require some minor modifications to provide hooks for
