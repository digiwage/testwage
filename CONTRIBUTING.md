Contributing to Testwage Core
============================

The Testwage Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Testwage Core project, and is not to be
confused with overall Testwage Network Protocol consensus changes.

Whether a pull request is merged into Testwage Core rests with the project merge
...
Patches that change Testwage consensus rules are considerably more involved than
...
Where a patch set proposes to change the Testwage consensus, it must have been
...
The project leader is the release manager for each Testwage Core release.
