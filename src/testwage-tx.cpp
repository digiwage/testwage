...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Testwage Core testwage-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  testwage-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded testwage transaction") + "\n" +
                               "  testwage-tx [options] -create [commands]   " + _("Create hex-encoded testwage transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded testwage transaction
