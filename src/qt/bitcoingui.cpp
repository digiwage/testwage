                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Testwage Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Testwage address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and testwage: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Testwage Core"), this);
    aboutAction->setStatusTip(tr("Show information about Testwage Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Testwage"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Testwage addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Testwage addresses"));
    ...
    openAction->setStatusTip(tr("Open a Testwage: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Testwage Core help message to get a list with possible Testwage command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Testwage Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Testwage network", "", count));
}
...
{
    QString strTitle = tr("Testwage Core"); // default title
