...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Testwage Core"),
     ...
     * override -datadir in the testwage.conf file in the default data directory
     * (to be consistent with testwaged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
