...
RESOURCES += src/qt/testwage.qrc src/qt/testwage_locale.qrc

TRANSLATIONS += src/qt/locale/testwage_bg.ts \
                src/qt/locale/testwage_de.ts \
                src/qt/locale/testwage_en.ts \
                src/qt/locale/testwage_es.ts \
                src/qt/locale/testwage_fi.ts \
                src/qt/locale/testwage_fr.ts \
                src/qt/locale/testwage_it.ts \
                src/qt/locale/testwage_ja.ts \
                src/qt/locale/testwage_pl.ts \
                src/qt/locale/testwage_pt.ts \
                src/qt/locale/testwage_ru.ts \
                src/qt/locale/testwage_sk.ts \
                src/qt/locale/testwage_sv.ts \
                src/qt/locale/testwage_vi.ts \
                src/qt/locale/testwage_zh_CN.ts \
                src/qt/locale/testwage_zh_TW.ts
